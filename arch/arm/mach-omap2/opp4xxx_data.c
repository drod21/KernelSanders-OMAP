...
#define OMAP4460_VDD_MPU_OPP75_UV		990000
#define OMAP4460_VDD_MPU_OPP100_UV		1080000
#define OMAP4460_VDD_MPU_OPPTURBO_UV		1170000
#define OMAP4460_VDD_MPU_OPPNITRO_UV		1260000
#define OMAP4460_VDD_MPU_OPPOC_UV		1350000

struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP25_UV, OMAP44XX_CONTROL_FUSE_MPU_OPP25, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP50_UV, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP75_UV, OMAP44XX_CONTROL_FUSE_MPU_OPP75, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
...
struct omap_volt_data omap446x_vdd_iva_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPP25_UV, OMAP44XX_CONTROL_FUSE_IVA_OPP25, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPP50_UV, OMAP44XX_CONTROL_FUSE_IVA_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPP75_UV, OMAP44XX_CONTROL_FUSE_IVA_OPP75, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	/* MPU OPP1 - OPP25 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 250000000, OMAP4460_VDD_MPU_OPP50_UV),
	/* MPU OPP2 - OPP50 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 350000000, OMAP4460_VDD_MPU_OPP50_UV),
	/* MPU OPP3 - OPP75 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 500000000, OMAP4460_VDD_MPU_OPP100_UV),
	/* MPU OPP4 - OPP100 */
