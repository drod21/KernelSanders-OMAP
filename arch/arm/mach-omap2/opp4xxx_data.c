...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	...
	//VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPORIG_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	/* MPU OPP6 - OPP-ORIG */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 1040000000, OMAP4460_VDD_MPU_OPPTURBO_UV),
	/* MPU OPP7 - OPP-Nitro */
