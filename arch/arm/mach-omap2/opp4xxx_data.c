...
#define OMAP4460_VDD_MPU_OPPORIG_UV		1225000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPORIG_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
...
#define OMAP4460_VDD_IVA_OPP100_UV		1100000
#define OMAP4460_VDD_IVA_OPPTURBO_UV		1250000
#define OMAP4460_VDD_IVA_OPPNITRO_UV		1350000
...
struct omap_volt_data omap446x_vdd_core_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP50_UV, 38000, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_UV, 13000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OV_UV, 13000, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	** Disable for now. It's causing battery drain and instability
	...
	/* MPU OPP6 - OPP-ORIG */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 1008000000, OMAP4460_VDD_MPU_OPPORIG_UV),
	/* MPU OPP7 - OPP-Nitro */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1200000000, OMAP4460_VDD_MPU_OPPNITRO_UV),
	/* MPU OPP8 - OPP-Nitro SpeedBin */
