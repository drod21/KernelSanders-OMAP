/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/jenkins/workspace/linaro-android_toolchain-4.7-2012.04/build/objdir/temp-src/gcc-linaro-4.7-2012.04/gcc/config/arm/arm.md'.  */
