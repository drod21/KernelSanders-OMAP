...
enum opt_code
{
  ...
  OPT_mapcs = 983,                           /* -mapcs */
  OPT_mapcs_float = 984,                     /* -mapcs-float */
  OPT_mapcs_frame = 985,                     /* -mapcs-frame */
  OPT_mapcs_reentrant = 986,                 /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 987,               /* -mapcs-stack-check */
  OPT_march_ = 988,                          /* -march= */
  OPT_marm = 989,                            /* -marm */
  OPT_mbig_endian = 990,                     /* -mbig-endian */
  OPT_mcallee_super_interworking = 991,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 992,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 993,       /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 994,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 995,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 996,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 997,                   /* -mfp16-format= */
  /* OPT_mfp_2 = 998, */                     /* -mfp=2 */
  /* OPT_mfp_3 = 999, */                     /* -mfp=3 */
  OPT_mfpe = 1000,                           /* -mfpe */
  /* OPT_mfpe_2 = 1001, */                   /* -mfpe=2 */
  /* OPT_mfpe_3 = 1002, */                   /* -mfpe=3 */
  OPT_mfpu_ = 1003,                          /* -mfpu= */
  /* OPT_mhard_float = 1004, */              /* -mhard-float */
  OPT_mlittle_endian = 1005,                 /* -mlittle-endian */
  OPT_mlong_calls = 1006,                    /* -mlong-calls */
  OPT_mpic_register_ = 1007,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1008,            /* -mpoke-function-name */
  OPT_msched_prolog = 1009,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1010,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1011, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1012,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1013,                         /* -mthumb */
  OPT_mthumb_interwork = 1014,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1015,                  /* -mtls-dialect= */
  OPT_mtp_ = 1016,                           /* -mtp= */
  OPT_mtpcs_frame = 1017,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1018,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1019,                         /* -mtune= */
  OPT_munaligned_access = 1020,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1021,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1022,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1023,              /* -mword-relocations */
  OPT_mwords_little_endian = 1024,           /* -mwords-little-endian */
  OPT_n = 1025,                              /* -n */
  ...
  OPT_r = 1053,                              /* -r */
  OPT_remap = 1054,                          /* -remap */
  OPT_s = 1055,                              /* -s */
  OPT_s_bc_abi = 1056,                       /* -s-bc-abi */
  OPT_save_temps = 1057,                     /* -save-temps */
  OPT_save_temps_ = 1058,                    /* -save-temps= */
  OPT_shared = 1059,                         /* -shared */
  OPT_shared_libgcc = 1060,                  /* -shared-libgcc */
  /* OPT_specs = 1061, */                    /* -specs */
  OPT_specs_ = 1062,                         /* -specs= */
  OPT_static = 1063,                         /* -static */
  OPT_static_libgcc = 1064,                  /* -static-libgcc */
  OPT_static_libgcj = 1065,                  /* -static-libgcj */
  OPT_static_libgfortran = 1066,             /* -static-libgfortran */
  OPT_static_libgo = 1067,                   /* -static-libgo */
  OPT_static_libstdc__ = 1068,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1069, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1070, */                /* -std=c++0x */
  OPT_std_c__11 = 1071,                      /* -std=c++11 */
  OPT_std_c__98 = 1072,                      /* -std=c++98 */
  OPT_std_c11 = 1073,                        /* -std=c11 */
  ...
  OPT_std_f2008ts = 1081,                    /* -std=f2008ts */
  OPT_std_f95 = 1082,                        /* -std=f95 */
  OPT_std_gnu = 1083,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1084, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1085, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1086,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1087,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1088,                      /* -std=gnu11 */
  ...
  /* OPT_std_iso9899_2011 = 1098, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1099,                     /* -std=legacy */
  OPT_symbolic = 1100,                       /* -symbolic */
  OPT_t = 1101,                              /* -t */
  OPT_time = 1102,                           /* -time */
  OPT_time_ = 1103,                          /* -time= */
  OPT_traditional = 1104,                    /* -traditional */
  OPT_traditional_cpp = 1105,                /* -traditional-cpp */
  OPT_trigraphs = 1106,                      /* -trigraphs */
  OPT_u = 1107,                              /* -u */
  OPT_undef = 1108,                          /* -undef */
  OPT_v = 1109,                              /* -v */
  OPT_version = 1110,                        /* -version */
  OPT_w = 1111,                              /* -w */
  OPT_wrapper = 1112,                        /* -wrapper */
  OPT_x = 1113,                              /* -x */
  OPT_z = 1114,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
